...
Функция ПроверитьРезультатВыполненияЗадачи(СсылкаДиалога) Экспорт
	...
	Возврат ИИА_Сервер.ПроверитьРезультатВыполненияЗадачи(СсылкаДиалога);
...
Функция ВызватьИИССистемнымСообщением(СсылкаДиалога, ТипСообщения, ТекстСистемногоСообщения, СистемныйПромпт = "", ExpectedResponseFormat = "dsl") Экспорт
	...
	Возврат ИИА_Сервер.ВызватьИИССистемнымСообщением(СсылкаДиалога, ТипСообщения, ТекстСистемногоСообщения, СистемныйПромпт, ExpectedResponseFormat);
...
Функция ИнициализироватьПлан(СсылкаДиалога) Экспорт
	...
	Возврат ИИА_Сервер.ИнициализироватьПлан(СсылкаДиалога);
...
Функция ОбновитьПланПоРезультатам(СсылкаДиалога) Экспорт
	...
	Возврат ИИА_Сервер.ОбновитьПланПоРезультатам(СсылкаДиалога);
...
Функция ПолучитьСледующийПунктПлана(СсылкаДиалога) Экспорт
	...
	Возврат ИИА_Сервер.ПолучитьСледующийПунктПлана(СсылкаДиалога);
...
Функция ПланЗавершен(СсылкаДиалога) Экспорт
	...
	Возврат ИИА_Сервер.ПланЗавершен(СсылкаДиалога);
...
Функция ПолучитьПланДиалога(СсылкаДиалога) Экспорт
	...
	Возврат ИИА_Сервер.ПолучитьПланДиалога(СсылкаДиалога);
