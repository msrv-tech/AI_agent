...
Функция ИсправитьDSLЧерезИИ(СсылкаДиалога, ТекстОшибки, ИсходныйDSL) Экспорт
	...
	Возврат ВызватьИИССистемнымСообщением(СсылкаДиалога, "Чат", ПромптИсправления, "", "dsl");
...
//
Функция ВызватьИИССистемнымСообщением(СсылкаДиалога, ТипСообщения, ТекстСистемногоСообщения, СистемныйПромпт = "", ExpectedResponseFormat = "dsl") Экспорт
	...
	ОтветИИ = ИИА_Провайдеры.ВызватьИИ(ТипСообщения, ТекстСистемногоСообщения, История, Настройки, СистемныйПромптДляВызова);
	...
	ДобавитьЗаписьВЛогДиалога(
		СсылкаДиалога,
		"[LLM_REQUEST] CallId=" + CallId +
		", Type=" + ТипСообщения +
		", ExpectedResponseFormat=" + ExpectedResponseFormat +
		", Model=" + МодельДляЛога +
		", Temperature=0.0" + Символы.ПС +
		ОтветИИ.Промпт
	);
