	...
	Попытка
		...
		Пока ПопыткаЗаписи < 3 Цикл
			...
			Исключение
				...
				Если ПопыткаЗаписи >= 3 Тогда
					ВызватьИсключение "Ошибка при установке флага ТаблицаПоказана: " + ТекстОшибки;
				КонецЕсли;
			КонецПопытки;
		КонецЦикла;
	Исключение
		ВызватьИсключение "Ошибка при установке флага ТаблицаПоказана: " + ОписаниеОшибки();
	КонецПопытки;
	...
	Попытка
		...
		Пока ПопыткаЗаписи < 3 Цикл
			...
			Исключение
				ТекстОшибки = ОписаниеОшибки();
				Если ПопыткаЗаписи >= 3 Тогда
					ВызватьИсключение "Ошибка при записи данных запроса в хранилище: " + ТекстОшибки;
				КонецЕсли;
			КонецПопытки;
		КонецЦикла;
	Исключение
