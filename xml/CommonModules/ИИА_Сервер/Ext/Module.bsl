...
Функция ИзвлечьСущностиДляRAG(Знач ТекстЗапроса) Экспорт
	...
	// Параметры: ТипСообщения, ТекстПользователя, История, Настройки, СистемныйПромпт, Температура
	ОтветИИ = ИИА_Провайдеры.ВызватьИИ("Чат", Промпт, Неопределено, Настройки, "", 0.0);
