...
//
Функция ВызватьИИ(ТипСообщения, ТекстПользователя, История, Настройки, СистемныйПромпт = "", Температура = Неопределено) Экспорт
	...
	Результат = ВызватьGitsellAiProxy(ТипСообщения, ТекстПользователя, История, Настройки, СистемныйПромпт, Температура);
...
//  Структура - результат
//
Функция ВызватьGitsellAiProxy(ТипСообщения, ТекстПользователя, История, Настройки, СистемныйПромпт = "", Температура = Неопределено)
