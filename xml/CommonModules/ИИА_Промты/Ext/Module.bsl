...
Функция ПолучитьТекстПромпта_Агент()
	...
	"- После получения списка метаданных (GetMetadata) ВСЕГДА анализируй его на наличие объектов со схомими именами. Если ты искал 'Реализация' и не нашел, но в списке есть 'РасходнаяНакладная' — используй её." + Символы.ПС +
