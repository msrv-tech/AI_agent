...
Функция ПолучитьТекстПромпта_Агент()
	...
	"- ТЕБЕ ДОСТУПЕН RAG-ПОИСК: В сообщениях системы может быть блок 'ПОДСКАЗКА ПО МЕТАДАННЫМ (RAG)'. Всегда отдавай приоритет именам объектов и полям из этого блока." + Символы.ПС +
		"- ЕСЛИ CheckObjectExists ВЕРНУЛ 'не существует': в блоке RAG уже есть список объектов из базы — ИСПОЛЬЗУЙ один из них (например Документ.РасходнаяНакладная вместо РеализацияТоваровУслуг). НЕ зацикливайся на несуществующем объекте." + Символы.ПС +
