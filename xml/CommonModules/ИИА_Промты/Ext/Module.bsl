...
Функция ПолучитьТекстПромпта_Агент()
	...
	"- После получения списка метаданных (GetMetadata) ВСЕГДА анализируй его на наличие объектов со схожими именами, прежде чем пробовать другие действия." + Символы.ПС +
