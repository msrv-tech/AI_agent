...
Функция ПолучитьСинонимы() Экспорт
	...
	// Кейс 11: задолженность и маржинальность
	Синонимы.Вставить("дебиторка", СтрРазделить("задолженность,взаиморасчеты,расчетысклиентами,долг", ",", Ложь));
	Синонимы.Вставить("задолженность", СтрРазделить("дебиторка,долг,взаиморасчеты,расчетысклиентами,кредиторка", ",", Ложь));
	Синонимы.Вставить("взаиморасчеты", СтрРазделить("задолженность,расчетысклиентами,долг,дебиторка", ",", Ложь));
	Синонимы.Вставить("просрочка", СтрРазделить("задолженность,дебиторка,срокоплаты,долг", ",", Ложь));
	Синонимы.Вставить("прайс", СтрРазделить("ценыноменклатуры,ценыноменклатуры25,цена,стоимость,прайслист", ",", Ложь));
	Синонимы.Вставить("прайслист", СтрРазделить("ценыноменклатуры,прайс,цена,установкацен", ",", Ложь));
	Синонимы.Вставить("маржа", СтрРазделить("маржинальность,прибыль,себестоимость,наценка", ",", Ложь));
	Синонимы.Вставить("маржинальность", СтрРазделить("маржа,прибыль,себестоимость,наценка,рентабельность", ",", Ложь));
	Синонимы.Вставить("себестоимость", СтрРазделить("закупочнаяцена,цена,маржа,маржинальность", ",", Ложь));
	Синонимы.Вставить("покупатель", СтрРазделить("контрагент,клиент,партнер,заказчик", ",", Ложь));
