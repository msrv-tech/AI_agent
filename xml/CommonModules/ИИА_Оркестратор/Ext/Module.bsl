...
Функция НужноИспользоватьRAGДляПлана(ТекстЗадачи, ТипДиалога) Экспорт
...
Функция ИнициализироватьПлан(СсылкаДиалога) Экспорт
	...
	ИспользоватьRAG = НужноИспользоватьRAGДляПлана(ТекстЗадачи, СсылкаДиалога.ТипДиалога);
	ОтветИИ = ИИА_Сервер.ВызватьИИССистемнымСообщением(СсылкаДиалога, "Чат", ПромптПлана, ИИА_Промты.ПолучитьТекстПромптаПланировщика(), "plan_json_array", , ИспользоватьRAG);
