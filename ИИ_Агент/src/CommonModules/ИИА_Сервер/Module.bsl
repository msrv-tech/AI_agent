...
Функция ИсправитьDSLЧерезИИ(СсылкаДиалога, ПромптИсправления) Экспорт
	...
	// Используем обычную функцию ОтправитьСообщениеСервера, которая передаст всю историю диалога
	// История уже содержит все ошибки выполнения DSL, которые будут переданы автоматически
	Возврат ОтправитьСообщениеСервера(СсылкаДиалога, "Чат", ПромптИсправления);
