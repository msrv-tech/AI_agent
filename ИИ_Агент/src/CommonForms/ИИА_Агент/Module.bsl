	...
	ИначеЕсли СтатусDSL = ПредопределенноеЗначение("Перечисление.ИИА_СтатусDSL.ОбработанУспешно") Тогда
		...
		Иначе
			...
			ПромптПродолжения = "Задача пользователя еще не выполнена полностью. " + Символы.ПС +
				...
				"ВАЖНО о разбиении больших задач:" + Символы.ПС +
				"- Если задача требует обработки большого количества объектов (более 10-20), разбей её на несколько DSL-сценариев" + Символы.ПС +
				"- Первый сценарий: получи список всех объектов и сохрани в хранилище" + Символы.ПС +
				"- Второй и последующие сценарии: загрузи данные из хранилища, обработай следующий пакет объектов (10-20 штук), обнови счетчик в хранилище" + Символы.ПС +
